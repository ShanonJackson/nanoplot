					...
					data={[
						{
							name: "New Users",
							stroke: "#FF4B4B",
							fill: "linear-gradient(to bottom, #FF4B4B 0%, #FF4B4B 100%)",
							data: [
						...
						},
						{
							...
							stroke: "#33D4FF",
							data: [
								{ x: Temporal.Instant.from("2024-01-01T00:00:00Z"), y: 25 },
								{ x: Temporal.Instant.from("2024-02-01T00:00:00Z"), y: 15 },
								{ x: Temporal.Instant.from("2024-03-01T00:00:00Z"), y: 25 },
								{ x: Temporal.Instant.from("2024-04-01T00:00:00Z"), y: 35 },
								{ x: Temporal.Instant.from("2024-05-01T00:00:00Z"), y: 35 },
								{ x: Temporal.Instant.from("2024-06-01T00:00:00Z"), y: 40 },
								{ x: Temporal.Instant.from("2024-07-01T00:00:00Z"), y: 50 },
