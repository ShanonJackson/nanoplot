				...
				<Graph
					...
					data={[
						...
						},
						{
							...
							stroke: "#33D4FF",
							data: [
								{ x: new Date(2024, 0, 1, 0, 0, 0, 0), y: 25 },
								{ x: new Date(2024, 1, 1, 0, 0, 0, 0), y: 15 },
								{ x: new Date(2024, 2, 1, 0, 0, 0, 0), y: 25 },
								{ x: new Date(2024, 3, 1, 0, 0, 0, 0), y: 35 },
								{ x: new Date(2024, 4, 1, 0, 0, 0, 0), y: 35 },
								{ x: new Date(2024, 5, 1, 0, 0, 0, 0), y: 40 },
								{ x: new Date(2024, 6, 1, 0, 0, 0, 0), y: 50 },
