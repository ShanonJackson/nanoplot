	...
	return (
		<html lang="en" data-theme={theme}>
			<body
				...
				className={
					theme +
					" h-full w-full overflow-hidden bg-[hsl(0deg,0%,100%)] dark:bg-[hsl(210deg,22.22%,10.59%)] text-[hsl(0deg,0%,0%)] dark:text-[hsl(0deg,0%,100%)] transition-colors duration-200"
				}
			>
