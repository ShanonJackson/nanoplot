...
const HeaderPage = (props: Props) => {
	return (
		<div className="w-full flex flex-row-reverse lg:flex-row justify-between lg:justify-end items-center gap-4 px-4 bg-gradient-to-r from-primary to-primary-foreground text-white">
			...
			<Link href={"https://github.com/plotly/nanoplot"} className="hidden lg:block w-fit px-4 text-sm cursor-pointer">
				<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 496 512" height="23px" width="23px">
