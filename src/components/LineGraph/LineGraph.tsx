...
export const LineGraph = ({ children }: Props) => {
	...
	return (
		<div className={cx("relative", "w-full", "h-full", "flex", "flex-col", styles.base)} ref={ref}>
			<div className={"flex-shrink-0 height-[80px] border-solid border-[red] border-[1px]"}>POTENTIALLY LEGEND</div>
			...
			<div className={"flex-shrink-0 h-20 border-solid border-[red] border-[1px]"}>POTENTIALLY LEGEND</div>
			{children}
		</div>
	);
};
